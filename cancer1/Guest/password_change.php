...
if (isset($_POST['email']) && isset($_POST['new_pass'])
	...
	if($pass !== $re_pass){
        ...
        $sql = "SELECT * FROM donor WHERE donor_email='$Email_Address' ";
		...
		if (mysqli_num_rows($result) > 0) {
            ...
            if($code1 !== $code){
                ...
                $sql2 = "UPDATE donor SET password='$pass' WHERE donor_email='$Email_Address' LIMIT 1";
...
function send_login_qr_code($Email_Address,$pass,$name)
    {
		require ('../../vendor-QR/autoload.php');
			...
			$mail->Password   = "vghkwhpnvkbthjuw";                               //SMTP password
