...
<section id="about_us" class="about_us">
    ...
    <div class="boarder">
        <div class="p-5 row text-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="tab1">Why Donate Drugs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab2">How to Donate</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab3">Updated Drug List</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab1 text-justify ps-5 pe-5 pb-5">
            ...
            <b class="text-center">Why Cancer Hospital Need drug donations</b>
            <p>Cancer hospitals in Sri Lanka rely on donations from people to support patient care and treatment.Because of the severe difficulties that a rural hospital is currently having in providing amenities for patients. As a result, buying the wanted drugs from the hospital is challenging.In order to meet their needs, the hospital is appealing for contributors' donations. Because if there is no drugs the patients are inconvinience and sometimes they have to die because they didn't receive drugs ontime. So, hospital will seek your support for them.
            
</p>
            <ul >
                <li>Donations help provide necessary drugs for cancer patients.</li>
                <li>Donations support the research and development of new cancer treatments and therapies.</li>
                <li>Donations from the public contribute to creating a compassionate and supportive environment for cancer patients and their families because most of the patients and their families don't have enough money for buying their needed drugs.</li>
            </ul> 
<b style="color:red;">Please consider the following when you donate :</b>
            <br>
            <span style="color:red;">&#42;   &#42;  &#42; Please be kind enough to purchase items with a long expiry date. (at least one year).  &#42;   &#42;  &#42; </span>
        ...
        <div class="tab2 ps-5 pe-5 pb-5 display-none">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <p>When you went to updated drug list tab you can see the updated current drug list.
        ...
        <p>We sincerely appreciate your generous donations. We kindly request that you obtain official approval from the hospital prior to directly providing donations to inward and clinic patients. Additionally, we urge you to verify the patients with the medical staff before distributing food, supplements, and medicines donations.</p>
            ...
            <?php
             ...
             <div class="table-responsive small">
                 <table class="table table-bordered" id="datatabledrug" width="100%" celllspacing="0" style="font-size: 12px;">
                   <thead>
                     <tr>
                       <th>Drug List</th>
                       <th>Weight</th>
