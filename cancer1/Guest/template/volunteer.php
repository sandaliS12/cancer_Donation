<section id="about_us" class="about_us">
    ...
    <div class="boarder">
        <div class="p-5 row text-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="tab1">Why Want Volunteers</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab2">How to Register</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab3">What kind of Activities you can register</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab4">Volunteer Gallery</a>
            </li>
            </ul>
        ...
        <div class="tab1 text-justify ps-5 pe-5 pb-5">
            ...
            <b class="text-center">Why We want volunteers</b>
            <p>If someone or a community
wants to organize an entertainment program for children ward or any other ward,
you want to meet the head of the ward and
request permission from that person. After getting his permission, then the requesting
person should write a letter and go to the director and give it to him and get his approval.
This will take more time and 
Sometimes you had to spend whole day for the hospital because, sometimes director is
in long meetings and so on. So, if you sent a request with your details we can handle it online and then you can save your time. 
            <br><br>
<b style="color:red;">Please consider the following when you request :</b>
            <br>
            <span style="color:red;">&#42;   &#42;  &#42; Please be kind enough to add your correct details and working contact numbers. Because, we have to contact you further.  &#42;   &#42;  &#42; </span>
        ...
        <div class="tab2 ps-5 pe-5 pb-5 display-none">
            <div class="text-center">
                ...
                <p>The Volunteers registration process is as follow.</p>
            </div>
            <b>Search</b>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <p>If you/your organization wants to organise a entertainment activity for any kind of ward firstly you should login to the system.
