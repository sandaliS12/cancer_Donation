...
if($_POST["action"] == "donorEmail_send")
{
   ...
   $mail->Subject = "To collect current needed blood samples";

   $email_template = "
   <h2>Dear $donor_name ,</h2>
   <h3>$donor_Message</h3>
   <h3>if you can donate soon please be kind enough to contact through our contact numbers or please add a booking and visit us. </h3>
