...
if($_POST["action"] == "receiveBloodDonorEmail_send")
{
    echo 'came';
    $Vo_Name1 = $_POST['Bdonor_name'];

    $Vo_Email1 = $_POST['Bdonor_email'];
    
    $Vo_Message1 = $_POST['Bdonor_Message'];

	$EventVo_ID1 = $_POST['BEvent_ID1'];
	...
	echo $Vo_Name1;
        ...
        $mail->Password   = "lmwoluzfjwegpqim";                               //SMTP password
        ...
        $mail->addAddress($Vo_Email1);     //Add a recipient
        ...
        $email_template = "
        <h2>Dear $Vo_Name1 ,</h2>
		<h3>Under this critical time, we appreciate your valuble contribution. Your team made their happiness even for a while. Thank you for join with us. Hope your donations further</h3>
        <h3>$Vo_Message1</h3>
		...
		$sql2 = "UPDATE events1 SET Status='5' where ID='$EventVo_ID1'";
