<section id="about_us" class="about_us">
    ...
    <div class="boarder">
        <div class="p-5 row text-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="tab1">why Blood</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab2">How to Donate</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab3">Donate Camps</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab4">Gallery</a>
            </li>
            </ul>
        ...
        <div class="tab1 text-justify ps-5 pe-5 pb-5">
            ...
            <ul >
                <li>Every 56 days, up to 6 times a year</li>
